...
export const dependenciaSchema = z
    .object({
        // Asumiendo que hay un ID único para la combinación Dependencia/Costo
        id: z.number().int().positive().optional(), 
        dependencia: z.string().trim(), // Municipal, Particular Pagado, etc.
        costo_matricula: z.string().trim(), // $1.000 A $10.000, etc.
    })
    .strict();

export type DependenciaCosto = z.infer<typeof dependenciaSchema>;