...
const safeNumber = z.preprocess(emptyToUndefined, z.coerce.number().int().positive()).optional();

// Enums de dominio
export const RoleEnum = z.enum(["user", "manager", "admin"]); // roles validos de usuario
export const StatusEnum = z.enum(["active", "inactive"]); // estados posibles de la cuenta
