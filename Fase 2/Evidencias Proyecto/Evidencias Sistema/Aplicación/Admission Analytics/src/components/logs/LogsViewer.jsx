...
export default function LogsViewer(isAdmin = true) {
  ...
  // llamar metadatos de acciones y usuarios
    ...
    [filters.action, filters.performed_by_email, filters.date_from, endInclusiveISO]);
    ...
    return (
        ...
        <div className="mb-4 flex items-center justify-between gap-4">
            ...
            <div className="text-sm">
                ...
                Se exportan según los filtros actuales.
                </p>
            </div>
            {/* Botones */}
            <div className="flex gap-2">
                ...
                disabled={isExporting || isLoading || !isAdmin}
        ...
        <div className="overflow-x-auto">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                ...
                // Usamos flatMap para emitir 1 o 2 filas por log con keys únicas y estables
                logs.flatMap((log) => {
                    const rows = [
                    <tr
                        key={log.log_id}
